...
[![Location](https://img.shields.io/badge/Torrej%C3%B3n%20de%20Ardoz-5DCAA5?style=for-the-badge&logo=googlemaps&logoColor=white)]()
...
Technically focused on **concurrent and distributed systems** (Java RMI, POSIX threads), **advanced databases** (PostgreSQL, Oracle, RBAC) and **algorithms** (Dynamic Programming, Backtracking, Branch and Bound). Analytical methodology grounded in a background in Astrophysics.
...
| 💻 | [Danix29.github.io repo](https://github.com/Danix29/Danix29.github.io) | Source code of the portfolio |
...
*B.S. Computer Engineering · Universidad de Alcala de Henares · Torrejon de Ardoz, Madrid*
