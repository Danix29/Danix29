...
## 🎓 Grado en Ingeniería Informática · UAH · 2024–2028

> Todo el trabajo organizado **un repositorio por asignatura**. Cada repo contiene prácticas de laboratorio, proyectos y documentación de esa asignatura.
...
| Asignatura | Repositorio | Stack | Descripción |
|---------|-----------|-------|-------------|
| Sistemas Operativos | [sistemas-operativos](https://github.com/Danix29/sistemas-operativos) | ![Linux](https://img.shields.io/badge/Linux-FCC624?style=flat-square&logo=linux&logoColor=black) ![C](https://img.shields.io/badge/C-00599C?style=flat-square&logo=c&logoColor=white) | Servicios POSIX: gestión de procesos, pthreads, mutexes, semáforos, memoria. Simulación de carrera con clasificación compartida protegida por mutex |
| Arquitectura de Redes I | [arquitectura-redes-1](https://github.com/Danix29/arquitectura-redes-1) | ![Cisco](https://img.shields.io/badge/Cisco-1BA0D7?style=flat-square&logo=cisco&logoColor=white) | TCP/IP, subnetting, enrutamiento, switching, diseño LAN, configuración Cisco IOS |
| Arquitectura de Redes II | [arquitectura-redes-2](https://github.com/Danix29/arquitectura-redes-2) | ![Cisco](https://img.shields.io/badge/Cisco-1BA0D7?style=flat-square&logo=cisco&logoColor=white) | OSPF, BGP, EIGRP, VLANs, Spanning Tree, seguridad de red e ingeniería de tráfico |
| Fund. Tecnología de Computadores | [fundamentos-tecnologia-computadores](https://github.com/Danix29/fundamentos-tecnologia-computadores) | ![Digital](https://img.shields.io/badge/Lógica%20Digital-444441?style=flat-square) | Circuitos secuenciales y combinacionales: flip-flops, contadores, temporizadores, displays 7 segmentos |

#### 💻 Programación y Algoritmia

| Asignatura | Repositorio | Stack | Descripción |
|---------|-----------|-------|-------------|
| Programación Avanzada | [programacion-avanzada](https://github.com/Danix29/programacion-avanzada) | ![Java](https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=white) | Sistemas concurrentes y distribuidos: Java RMI, multithreading, gestión de deadlocks. Práctica: Batalla de Hawkins (16 clases, CyclicBarrier, Semaphore, RMI) |
| Estructuras de Datos | [estructuras-datos](https://github.com/Danix29/estructuras-datos) | ![C](https://img.shields.io/badge/C-00599C?style=flat-square&logo=c&logoColor=white) | Estructuras dinámicas en C: listas enlazadas, colas, pilas, árboles, gestión de memoria con malloc/free |
| Algoritmia y Complejidad | [algoritmia](https://github.com/Danix29/algoritmia) | ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) | Programación Dinámica, Backtracking, Branch and Bound. TSP + Mochila 0/1 doble restricción, Floyd-Warshall, Held-Karp O(n²·2ⁿ) |
| Ingeniería del Software | [ingenieria-software](https://github.com/Danix29/ingenieria-software) | ![Java](https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=white) | UML completo, SRS IEEE 830, JUnit, pruebas caja blanca/negra, complejidad ciclomática |
| Programación | [programacion](https://github.com/Danix29/programacion) | ![Java](https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=white) | POO: clases, herencia, polimorfismo, interfaces, colecciones, excepciones, E/S de ficheros |
| Fundamentos de Programación | [fundamentos-programacion](https://github.com/Danix29/fundamentos-programacion) | ![Java](https://img.shields.io/badge/Java-ED8B00?style=flat-square&logo=openjdk&logoColor=white) | Introducción a la programación: variables, control de flujo, funciones, recursión, POO básica en Java |

#### 🗄️ Bases de Datos y Matemáticas

| Asignatura | Repositorio | Stack | Descripción |
|---------|-----------|-------|-------------|
| Bases de Datos | [bases-datos](https://github.com/Danix29/bases-datos) | ![Oracle](https://img.shields.io/badge/Oracle-F80000?style=flat-square&logo=oracle&logoColor=white) | Modelo relacional, diseño ER, SQL, PL/SQL, triggers, RBAC. Práctica: BD F1 — 589K registros de vueltas, auditoría completa, 4 roles RBAC |
| Bases de Datos Avanzadas | [bases-datos-avanzadas](https://github.com/Danix29/bases-datos-avanzadas) | ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-316192?style=flat-square&logo=postgresql&logoColor=white) | Internos de PostgreSQL: almacenamiento físico, índices B-Tree/Hash, particionado, VACUUM/ANALYZE, monitorización E/S con pg_statio — 30M registros |
| Matemáticas Avanzadas | [matematicas-avanzadas](https://github.com/Danix29/matematicas-avanzadas) | ![Math](https://img.shields.io/badge/Matemáticas-7f77dd?style=flat-square) | Cálculo avanzado, álgebra lineal, métodos numéricos y matemáticas discretas |
| Estructuras Discretas | [estructuras-discretas](https://github.com/Danix29/estructuras-discretas) | ![Math](https://img.shields.io/badge/Matemáticas-7f77dd?style=flat-square) | Lógica, teoría de conjuntos, combinatoria, grafos, autómatas y lenguajes formales |
| Fundamentos Matemáticos | [fundamentos-matematicos](https://github.com/Danix29/fundamentos-matematicos) | ![Math](https://img.shields.io/badge/Matemáticas-7f77dd?style=flat-square) | Cálculo, álgebra lineal, matrices y valores propios aplicados a ingeniería |
| Estadística | [estadistica](https://github.com/Danix29/estadistica) | ![Math](https://img.shields.io/badge/Matemáticas-7f77dd?style=flat-square) | Probabilidad, distribuciones estadísticas, contraste de hipótesis, análisis de regresión |
...
- Evaluación preventiva sistemática de riesgos mediante procedimientos de evaluación estructurados, identificando y neutralizando peligros potenciales antes de su escalada
- Monitorización técnica y registro de parámetros críticos de infraestructura (calidad del agua, equipos de seguridad, condiciones de instalaciones) con ciclos de mantenimiento preventivo documentados
- Redacción y mantenimiento de informes operacionales de incidencias, registros de acceso y diarios de actividad conforme a estándares regulatorios
- Operación activa en entorno completamente bilingüe (ES/EN), comunicando directamente con personal militar internacional a diario
...
- Coordinación de horarios de actividades en múltiples grupos simultáneos (infantil, adultos, competición) optimizando la asignación de calles y recursos de instructores
- Cumplimiento pleno de la normativa de seguridad acuática, realizando inspección diaria de instalaciones y verificación de equipos antes de cada sesión
- Entrega de informes de progreso y documentación de incidencias a la dirección del centro, demostrando comunicación clara y responsabilidad a nivel institucional
